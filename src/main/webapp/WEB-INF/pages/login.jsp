...
<body>
    ...
    <div class="main-container">
        ...
        <div class="illustration-side">
            <div class="illustration-wrapper">
                <img src="images/Volunteers_login1.jpg" alt="Volunteers" class="illustration-img">
            ...
            <div class="form-wrapper">
                ...
                <div class="social-buttons">
                    <button type="button" class="social-btn google-btn" title="Google">
                        <svg viewBox="0 0 24 24"><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/></svg>
                    </button>
                ...
                <div class="signup-prompt">
                    ...
                    <a href="register.jsp" class="signup-link">Create Account</a>
                </div>
            </div>

            <!-- Footer in Login Section -->
    ...
    <script>
        ...
        // Form input validation animation
